// Vendored from https://github.com/moby/moby/blob/7fd2be6664adc124debfebc63e2d02a7df096056/daemon/volume/mounts/linux_parser.go
package volume
...
func (p *linuxParser) IsBackwardCompatible(m *MountPoint) bool {
	return m.Source != "" || m.Driver == "local"
}
