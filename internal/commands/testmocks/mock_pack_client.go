...
// BuildWithBuildkit mocks base method.
func (m *MockPackClient) BuildWithBuildkit(arg0 context.Context, arg1 client.BuildOptions) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BuildWithBuildkit", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// BuildWithBuildkit indicates an expected call of BuildWithBuildkit.
func (mr *MockPackClientMockRecorder) BuildWithBuildkit(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BuildWithBuildkit", reflect.TypeOf((*MockPackClient)(nil).BuildWithBuildkit), arg0, arg1)
}
